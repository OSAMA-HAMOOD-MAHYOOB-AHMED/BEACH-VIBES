const en = {
  ...
  account: {
    ...
    passwordFieldsRequired: 'Fill in all three password fields to change your password.',
    deleteAccountWarning: 'Permanently delete your account and order history. This cannot be undone.',
    deleteAccountAction: 'Delete Account',
    deleteAccountConfirmPrompt: 'Enter your password to confirm.',
...
const ar = {
  ...
  account: {
    ...
    passwordFieldsRequired: 'املأ حقول كلمة المرور الثلاثة لتغييرها.',
    deleteAccountWarning: 'سيؤدي هذا إلى حذف حسابك وسجل طلباتك نهائياً. لا يمكن التراجع عن هذا الإجراء.',
    deleteAccountAction: 'حذف الحساب',
    deleteAccountConfirmPrompt: 'أدخل كلمة المرور للتأكيد.',
    deleteAccountConfirmBtn: 'حذف حسابي نهائياً',
    deleting: 'جارٍ الحذف…',
